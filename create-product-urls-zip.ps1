# Create Sanborns_SanValentin_PRODUCT_URLS.zip
# Estructura: index.html (raiz), js/, css/, fonts/, assets/
$root = "c:\Users\maryp\San-Valentin-Sanborns"
$zipPath = Join-Path $root "Sanborns_SanValentin_PRODUCT_URLS.zip"
...
Write-Host "Created: Sanborns_SanValentin_PRODUCT_URLS.zip ($sizeKb KB)"
